#standard liskov example

##here square is inherit from class rectangle but it is not following his superclass base property. hence breaking liskov principle and make things inconsitent
